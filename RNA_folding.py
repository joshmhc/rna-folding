...
def load_sequence_from_sequences_txt(file_name: str) -> str:
    ...
    Expected format: Just the sequence on each line.
    All lines are concatenated together.
    ...
    if not seq:
        raise ValueError(f"No sequence parsed from {seq_path}. File should contain sequence data.")
